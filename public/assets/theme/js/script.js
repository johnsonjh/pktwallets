...
$jscomp.getGlobal = function(b) {
  return typeof window !== "undefined" && window === b
             ? b
             : typeof global !== "undefined" && global != null ? global : b;
};
...
$jscomp.polyfill = function(c, d, g, i) {
  if (d) {
    ...
    i = g[c];
    d = d(i);
    d != i && d != null && $jscomp.defineProperty(g, c, {
      configurable : !0,
      writable : !0,
      value : d,
    });
...
$jscomp.polyfill("Array.prototype.find", function(b) {
  return (b || function(c, d) { return $jscomp.findInternal(this, c, d).v; });
}, "es6", "es3");
(function(d) {
function g(a) {
  a = d(a);
...
function j(a) {
  ...
  a.find(".carousel-item .col-md-12").each(function() {
    e < 2 ? d(this).attr("class", "col-md-12")
          : e == "5" ? d(this).attr("class", "col-md-12 col-lg-15")
...
d.extend(d.easing, {
  easeInOutCubic : function(f, n, m, h, l) {
    return (n /= l / 2) < 1 ? (h / 2) * n * n * n + m
                            : (h / 2) * ((n -= 2) * n * n + 2) + m;
  },
});
d.fn.outerFind = function(e) { return this.find(e).addBack(e); };
  ...
  function a() {
    !h && m.outerHeight() <= f.outerHeight()
        ...
        : (m.css({"z-index" : "", position : "", bottom : ""}),
           m.css({width : ""}), l.css({"margin-bottom" : ""}));
  }
  var m = d(this);
  var l = m.prev();
  var f = d(window);
...
jQuery.fn[h] = function(
    l) { return l ? this.bind("resize", e(l)) : this.trigger(h); };
})(jQuery, "smartresize");
d.isMobile = function(a) {
  ...
  a == "*" ? (f = d.map(e, function(h) { return h; })) : a in e && f.push(e[a]);
  return !(!f.length ||
           !navigator.userAgent.match(new RegExp(f.join("|"), "i")));
};
const c = (function() {
  const a =
      d('<div style="height: 50vh; position: absolute; top: -1000px; left: -1000px;">')
          .appendTo("body");
  let f = a[0];
...
d(function() {
  function a() { d(this).css("height", (9 * d(this).parent().width()) / 16); }
  function r(f) {
    setTimeout(function() {
      d(f).outerFind(".mbr-parallax-background")
          .jarallax({speed : 0.6})
          .css("position", "relative");
    }, 0);
  }
  function p(f) {
    d(f).outerFind("[data-bg-video]").each(function() {
      ...
      if (t && (/youtu\.?be/g.test(t[3]) || /vimeo/g.test(t[3]))) {
        if (t && /youtu\.?be/g.test(t[3])) {
                      ...
                      function() {
                        if ((this.naturalWidth || this.width) === 120) {
                          ...
                          case "sddefault.jpg":
                            ...
                            break;
                          default:
                            k && s.css("background-image",
                                       'url("images/no-video.jpg")')
                                     .show();
                          }
                        } else {
                          s.css("background-image", 'url("' + this.src + '")')
                              .show();
                        }
                      })
                  .attr("src", h),
              !d.fn.YTPlayer || k || d.isMobile() ||
                  d("> *:eq(1)", this)
          ...
          if (t && /vimeo/g.test(t[3])) {
            ...
            n.open("GET", "https://vimeo.com/api/v2/video/" + t[6] + ".json",
                   !0);
            n.onreadystatechange = function() {
              if (this.readyState === 4) {
                if (this.status >= 200 && this.status < 400) {
                  ...
                  k && s.css("background-image", 'url("images/no-video.jpg")')
                           .show();
                }
              }
            };
            n.send();
            n = null;
            !d.fn.vimeo_player || k || d.isMobile() ||
                d("> *:eq(1)", this)
                    .before('<div class="mbr-background-video"></div>')
                    .prev()
                    .vimeo_player({
        ...
        k && s.css("background-image", 'url("images/video-placeholder.jpg")')
                 .show();
      }
    });
  }
  ...
  d(window).scroll(function() {
    d(".mbr-navbar--sticky").each(function() {
      ...
      d(this)[f]("mbr-navbar--stuck")
          .not(".mbr-navbar--open")[f]("mbr-navbar--short");
    });
  });
  d.isMobile() && navigator.userAgent.match(/Chrome/i)
      ...
      : c || (d(window).smartresize(function() {
          d(".mbr-section--full-height")
              .css("height", d(window).height() + "px");
        }),
  ...
  d.fn.jarallax && !d.isMobile() &&
      (d(window).on("update.parallax", function(f) {
        setTimeout(function() {
      ...
      }), k ? (d(document).on("add.cards", function(f) {
         r(f.target);
         d(window).trigger("update.parallax");
       }), d(document).on("changeParameter.cards", function(f, s, n, h) {
         if (s === "bg") {
           switch ((d(f.target).jarallax("destroy").css("position", ""), h)) {
           case "type":
         ...
         d(window).trigger("update.parallax");
       })) : r(document.body), d(window).on("shown.bs.tab", function(f) {
        d(window).trigger("update.parallax");
      }));
  let m;
  let q;
  ...
  d(window).scroll(function() {
    ...
    if (e) {
      ...
      n ? h != e.fixed && (l ? ((e.fixed = h), d(e.elm).toggleClass("is-fixed"))
                             : (q = setTimeout(
                                    function() {
                                      e.fixed = h;
  ...
  d(document).on("add.cards", function(f) {
    d("html").hasClass("pkt-site-loaded") &&
        d(f.target).outerFind("iframe").length && d(window).resize();
  });
  if (k) {
    d(document).on("add.cards", function(f) { p(f.target); });
  } else {
    p(document.body);
  }
  d(document).on("changeParameter.cards", function(f, s, n, h) {
        ...
        do {
          if (s.hash) {
            ...
            d(n ? "body" : s.hash).each(function() {
              ...
              t = s.hash == "#bottom" ? d(this).height() - d(window).height()
                                      : d(this).offset().top - t;
...
if (!k) {
  if (d.fn.titleLikes) {
    d(document).on("add.cards", function(a) {
      d(a.target)
          ...
          .on("counter.title-likes",
              function(f, l, h) {
                h > 999 && d(".title-likes__counter", f.target)
                               .html(Math.floor(h / 1000) + "k");
              })
  ...
  d(document).ready(function() {
    if (!d.isMobile() && d("input[name=animation]").length) {
      const a = function(m) {
        ...
        if (e.find(".carousel-item.active .hidden.animate__animated").lenght) {
          return !1;
        }
        if (e.attr("data-visible") > 1) {
          e = e.attr("data-visible");
          if (m.parents().is(".cloneditem-" + (e - 1)) &&
              m.parents(".cloneditem-" + (e - 1)).attr("data-cloned-index") >=
                  e) {
            return !0;
          }
      ...
      const h =
          d("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-title, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info")
              .not(function() {
                return d(this).parents().is(
  ...
  d(".nav-dropdown").length && d(".nav-dropdown").swipe({
    swipeLeft : function(a, n, m, l, h) { d(".navbar-close").click(); },
  });
}
d(document).ready(function() {
...
if (!k && (window.navigator.userAgent.indexOf("MSIE ") > 0 ||
      ...
      e.find(".carousel-indicators").addClass("ie-fix").find("li").css({
        ...
        width : "30px"
          ...
          e.hasClass("mbr-slider") &&
              e.find(".full-screen .slider-fullscreen-image")
                  .css("height", "1px");
    }
  });
}
  ...
  if (!k) {
    ...
    d(".modalWindow-video iframe").each(function() {
      ...
      const f = e.match(
          /(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/);
      e.indexOf("youtu") !== -1
          ? d(this).attr("src", "https://youtube.com/embed/" + f[6] +
                                    "?rel=0&enablejsapi=1")
          : e.indexOf("vimeo") !== -1 &&
                d(this).attr("src", "https://player.vimeo.com/video/" + f[6] +
                                        "?autoplay=0&loop=0");
    });
    d("[data-modal]").click(function() { a(d(this)); });
  }
});
if (!k && !d.isMobile()) {
  b = d("section.menu");
  const i = d(window).width();
  !b.find(".navbar").hasClass("collapsed") && i > 991 &&
      (b.find("ul.navbar-nav li.dropdown")
           .hover(
               function() {
       ...
       b.find("ul.navbar-nav li.dropdown .dropdown-menu .dropdown")
           .hover(
               function() {
                 d(this).hasClass("open") || d(this).find("a")[0].click();
               },
...
k ||
    (typeof window.initClientPlugin === "undefined" &&
         ...
         ((window.initClientPlugin = !0),
          d(document.body).find(".clients").each(function(a, e) {
     ...
     typeof window.initPopupBtnPlugin === "undefined" &&
         ...
         ((window.initPopupBtnPlugin = !0),
          d("section.popup-btn-cards .card-wrapper")
              .each(function(a, e) { d(this).addClass("popup-btn"); })),
     typeof window.initTestimonialsPlugin === "undefined" &&
         ...
         ((window.initTestimonialsPlugin = !0),
          d(".testimonials-slider").each(function() { g(this); })),
     typeof window.initSwitchArrowPlugin === "undefined" &&
         ((window.initSwitchArrowPlugin = !0), d(document).ready(function() {
           d(".accordionStyles").length != 0 &&
               d('.accordionStyles .card-header a[role="button"]')
                   .each(function() {
                     d(this).hasClass("collapsed") ||
                         d(this).addClass("collapsed");
                   });
         }),
           ...
           a.on("slide.bs.carousel", function() {
             ...
             a.find(".carousel-item.active").length > 1 &&
                 (a.find(".carousel-item.active").eq(1).removeClass("active"),
                  a.find(".carousel-control li.active")
                      .eq(1)
                      .removeClass("active"));
           });
         }));
if (k) {
  d(document).on("add.cards", function(a) {
    d(a.target).find(".form-with-styler").length &&
        ((a = d(a.target).find(".form-with-styler")),
         d(a).find('select:not("[multiple]")')
             .each(function() { d(this).styler(); }),
         d(a).find("input[type=number]").each(function() {
           d(this).styler();
           d(this).parent().parent().removeClass("form-control");
         }),
         d(a).find("input[type=date]").each(function() {
           d(this).datetimepicker &&
               d(this).datetimepicker({format : "Y-m-d", timepicker : !1});
         }),
         d(a).find("input[type=time]").each(function() {
           d(this).datetimepicker &&
  ...
  d("section .form-with-styler").each(function() {
    d(this)
        ...
        .each(function() { d(this).styler(); });
    d(this).find("input[type=number]").each(function() {
      d(this).styler();
      d(this).parent().parent().removeClass("form-control");
    });
    const a = navigator.userAgent.match(/Android/i) ||
                  ...
                  ? !0
                  : !1;
    !a && d(this).datetimepicker &&
        (d(this).find("input[type=date]").each(function() {
          d(this).datetimepicker({format : "Y-m-d", timepicker : !1});
        }),
         d(this).find("input[type=time]").each(function() {
           d(this).datetimepicker({format : "H:i", datepicker : !1});
         }));
  });
}
...
!(function() {
  try {
    document.getElementsById("top-1")[0]
