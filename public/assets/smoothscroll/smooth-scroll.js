  ...
  if (!ap && document.body) {
    ...
    if (top != self) {
      ...
      if (ax && r > m && (h.offsetHeight <= m || f.offsetHeight <= m)) {
        ...
        aK.offsetHeight <= m && ((m = document.createElement("div")),
                                 (m.style.clear = "both"), h.appendChild(m));
      }
    }
    aO.fixedBackground || ((h.style.backgroundAttachment = "scroll"),
...
function af(h, f, m) {
  ...
  if (!an) {
    ...
    var k = function(y) {
      ...
      l ? window.scrollBy(t, g)
        : (t && (h.scrollLeft += t), g && (h.scrollTop += g));
      f || m || (aH = []);
      aH.length ? ac(k, h, 1000 / aO.frameRate + 1)
                : ((an = !1), h.$scrollBehavior != null &&
...
function ab(g) {
  ap || aq();
  let f = g.target;
  if (g.defaultPrevented || g.ctrlKey || aI(aJ, "embed") ||
      (aI(f, "embed") && /\.pdf/i.test(f.src)) || aI(aJ, "object") ||
      f.shadowRoot) {
    return !0;
  }
  let h = -g.wheelDeltaX || g.deltaX || 0;
  let k = -g.wheelDeltaY || g.deltaY || 0;
  c && (g.wheelDeltaX && aD(g.wheelDeltaX, 120) &&
            (h = (g.wheelDeltaX / Math.abs(g.wheelDeltaX)) * -120),
        g.wheelDeltaY && aD(g.wheelDeltaY, 120) &&
  ...
  if (!f) {
    return aF && am
               ? (Object.defineProperty(g, "target",
                  ...
                  (g = new g.constructor(g.type, g)), parent.dispatchEvent(g))
               : !0;
  }
  if (az(k)) {
    return !0;
...
function ag(g) {
  let f = g.target;
  let m = g.ctrlKey || g.altKey || g.metaKey ||
  ...
  if (!(r = g.defaultPrevented || r.test(f.nodeName) ||
            (aI(f, "input") && !l.test(f.type)) || aI(aJ, "video"))) {
    r = g.target;
    let k = !1;
    if (document.URL.indexOf("www.youtube.com/watch") != -1) {
      do {
        if ((k = r.classList && r.classList.contains("html5-video-controls"))) {
          break;
        }
  ...
  case aN.pagedown:
    ...
    break;
  case aN.home:
    m == document.body && document.scrollingElement &&
...
function p(f) { aJ = f.target; }
function q() {
  clearTimeout(o);
  o = setInterval(function() { n = al = at = {}; }, 1000);
}
function ak(g, f, h) {
  h = h ? n : al;
...
function ay(g) {
  const f = aj(g);
  at[f] == null && ((g = getComputedStyle(g, "")["scroll-behavior"]),
                    (at[f] = g == "smooth"));
  return at[f];
}
function aI(g, f) {
...
function az(f) {
  if (f) {
    return (aM.length || (aM = [ f, f, f ]), (f = Math.abs(f)), aM.push(f),
            aM.shift(), clearTimeout(d),
            (d = setTimeout(function() {
               try {
                 localStorage.SS_deltaBuffer = aM.join(",");
               } catch (a) {
               }
             }, 1000)), (f = f > 120 && ai(f)), !ai(120) && !ai(100) && !f);
  }
}
function aD(g, f) { return Math.floor(g / f) == g / f; }
function ai(f) { return aD(aM[0], f) && aD(aM[1], f) && aD(aM[2], f); }
function ad(g) {
  g *= aO.pulseScale;
  if (g < 1) {
...
var aj = (function() {
  let f = 0;
  return function(a) { return a.uniqueID || (a.uniqueID = f++); };
})();
var n = {};
var al = {};
let o;
...
var ac = (function() {
  return (window.requestAnimationFrame || window.webkitRequestAnimationFrame ||
          ...
          function(g, f, h) { window.setTimeout(g, h || 1000 / 60); });
})();
var av = window.MutationObserver || window.WebKitMutationObserver ||
...
var ae = (function() {
  ...
  return function() {
    if (!f) {
      ...
      window.scrollBy(0, 3);
      f = document.body.scrollTop != g ? document.body
...
aG = aQ ? {passive : !1} : !1;
const ah = "onwheel" in document.createElement("div") ? "wheel" : "mousewheel";
ah && aL &&
...
typeof define === "function" && define.amd
    ...
    : typeof exports === "object" ? (module.exports = aB)
